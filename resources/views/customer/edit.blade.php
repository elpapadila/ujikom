            ...
            <form method="post" action="{{url('customer/update')}}">
                ...
                <div class="card-body">
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Masukkan Nama Pelanggan" value="{{$item->nama}}" required />
                    </div>
                    <div class="form-group mb-4">
                        <label for="alamat">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" placeholder="Masukkan Alamat" rows="3" required>{{$item->alamat}}</textarea>
                    </div>
                    <div class="form-group mb-4">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" class="form-control" name="telp" id="telp" placeholder="Masukkan Nomor Telepon" value="{{$item->telp}}" required />
                    </div>
                </div>
